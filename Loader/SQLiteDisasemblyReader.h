...
class SQLiteDisasemblyReader : public DisasemblyReader
{
private:
    sqlite3 *m_database;
...
public:
    SQLiteDisasemblyReader(const char *DatabaseName = NULL);
    ~SQLiteDisasemblyReader();
